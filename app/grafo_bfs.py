...
def criar_grafo_artistas_relacionados(artist_name, max_depth):
    ...
    # Deque para a busca em largura (BFS) com informações de profundidade
    fila = deque([(artist_name, 0)])  # Inicializa com profundidade 0 para o artista inicial
            ...
            if current_artist not in artistas_visitados:
                ...
                try:
                    ...
                    for related_artist in related_artists['artists']:
                        ...
                        # Adiciona o artista relacionado à fila com profundidade aumentada em 1 para continuar a busca em largura (BFS)
                        fila.append((related_artist_name, current_depth + 1))
                except IndexError:
                    # Caso nenhum resultado seja encontrado, continue com o próximo artista na fila
                    pass
...
nome_arquivo_json = './../GRAFO_JSON/grafo_id_'+ artista_inicial.replace( " ", "_")+'_bfs.json'
